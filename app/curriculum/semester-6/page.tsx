...
export default function Semester5Page() {
  ...
  const totalCredits =
    courses.reduce((sum, course) => sum + course.credits, 0) + 9; // 3 specialization courses × 3 credits
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl opacity-90 mb-6">
              Specialization begins - Choose your path
            </p>
      ...
      <div className="container mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-12">
            <div>
              ...
              <p className="text-xl text-gray-600 leading-relaxed mb-6">
                The fifth semester marks the beginning of specialization tracks.
                Students take core courses in air traffic control and aircraft
                maintenance while choosing their specialization area.
              </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto">
            Students select one specialization track and complete three
            specialized courses in their chosen area.
          </p>
            ...
            {specializationCourses.map((spec, index) => (
              ...
              >
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6">
                    <Link
                      href={`/programs/${spec.specialization
                        .toLowerCase()
                        .replace(/\s+/g, "-")}`}
                    >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-gray-600 mb-6 leading-relaxed">
                  Semester 5 includes hands-on training sessions and industry
                  visits to complement theoretical learning.
                </p>
                <ul className="space-y-3">
                  ...
                  <li className="flex items-center">
                    <div className="w-3 h-3 bg-[#0a4936] rounded-full mr-3"></div>
                    <span className="text-gray-700">
                      Specialization-specific Workshops
                    </span>
                  </li>
                </ul>
              </div>
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <Link
                ...
                className="text-[#0a4936] font-semibold hover:underline"
              >
                ← Semester IV
              </Link>
            </div>
